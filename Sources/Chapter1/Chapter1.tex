...
può convergere ad uno di rango $ 2 $, come mostra il prossimo esempio. Questo limita
...
Sia $ \mathcal{D}(n_1, n_2, \ldots, n_{d})$
\begin{definition}
  Il \emph{rango tipico} (o \emph{rango generico}) per un tensore di formato $ n_1 \times n_2 \times
  \cdots \times n_{d}$ è l'insieme dei ranghi che occorrono con probabilità non nulla, rispetto ad
