...
In questo elaborato supponiamo che in $ \K \in \{\R, \C\}  $, e denotiamo gli spazi vettoriali, che
...
\begin{example}[Tensore della matrix multiplication~\cite{landsberg2015geometry}]
	Come anticipazione di quanto approfondiremo nel Capitolo~\ref{chp:matmul}, la moltiplicazione di due matrici di taglia $ m \times n
