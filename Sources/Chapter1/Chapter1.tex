...
indichiamo l'insieme dei numeri $ \{1, 2, \ldots, n\}  $ con $ \underline{n} $ (o anche con $ [n] $).
...
\begin{definition}[Reshape]
	...
	che $ \prod_{i=1}^{d'} m_j = \prod_{j = 1}^{d} n_j$, il tensore $ Y = \reshape(T,
...
È inoltre possibile derivare un limite superiore debole per il rango massimo, tratto da~\cite[Pag. 275]{BK25},
\begin{equation}
...
\begin{remark}
	Facciamo un breakdown dei costi:
	\begin{itemize}
