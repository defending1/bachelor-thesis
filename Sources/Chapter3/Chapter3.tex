...
(\cdot) $. In questo contesto, il rango $ r $ assume anche il nome di \emph{complessità bilineare}.
...
In genrale, dato un algoritmo per un caso base fissato $ \angb{n,n,n} $, è possibile ottenerne uno per
$ \angb{\hat{n}, \hat{n}, \hat{n}} $, con $ \hat{n} >  n $, allargando la matrice  fino a far combaciare le dimensioni con quelle del caso base. In
particolare, 
\end{remark}
