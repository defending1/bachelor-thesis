...
Gli \emph{algoritmi di moltiplicazione veloce} sono degli algoritmi di moltiplicazione matriciale che
...
\begin{figure}[htbp]
	\centering
	\includegraphics{Sources/Chapter3/figures/algebraic_circuit_example.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.7\textwidth, keepaspectratio]{Sources/Chapter3/figures/circuit.pdf}
...
\end{proposition}
\todo{forse si possono dimostrare con qualche conticino}
...
dell'Equazione~\ref{eq:tensor_222}.
...
per matrici $ 3\times 3 $, sappiamo solo che $ 19 \le \rk(\algob{3}) \le 23 $~\cite{BLASER200343,
	bams/1183537626}; questo caso è ritenuto molto curioso peché esiste un'espressione nota per il
