...
\begin{remark}
  ...
  somma dei costi necessari a calcolare ogni $ \varphi_{i} $ da uno straight line program.\todo{CHECK IF DEF IS OK}
\end{remark}
...
\varphi_1, \ldots, \varphi_{n^2} $ come nell'Equazione~\ref{eq:b_active} \todo{Non chiaro, chiedere}.
...
algoritmi, si veda ad esempio Alphatensor~\cite{fawzi2022discovering}.
\begin{figure}[ht]
  \centering
