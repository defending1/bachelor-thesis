...
\angb{n} $, è possibile ottenerne uno per
$ \angb{\hat{n}} $, con $ \hat{n} >  n $, allargando la matrice aggiungendo zeri
fino alla dimensione
$ n^{\left\lceil \log \hat{n} \right\rceil } $. In particolare, si ha che
\begin{equation*}
  \begin{aligned}
    \rk(\angb{n}) \le \rk(\angb{n^{\left\lceil \log \hat{n} \right\rceil }})
  \end{aligned}
\end{equation*}
