...
\begin{figure}[htbp]
	...
	\caption{\textbf{Rappresentazione tridimensionale del tensore EEM.} Visualizzazione tridimensionale del tensore EEM di dimensioni $18 \times 251 \times 21$.}
...
\begin{figure}[htbp]
	...
	\caption{\textbf{Errore della decomposizione CP al variare del rango.} Errore relativo al variare del rango della decomposizione approssimante per il tensore EEM. Il rango
...
simile a quello che descriveremo nella \S~\ref{sec:num_experiment_omini}.


\begin{figure}[htbp]
	\centering
	\includegraphics[width=1\textwidth]{Sources/Chapter4/figures/eem_model.pdf}
	\caption{\textbf{Fattori della decomposizione CP non negativa ($r=3$).} Fattori della decomposizione CP non negativa a rango $r=3$ del tensore EEM. I diagrammi a barre a sinistra confrontano i profili di concentrazione calcolati con le concentrazioni effettive delle tre sostanze (Val-Tyr-Val, Trp-Gly, Phe).}
	\label{fig:eem_model}
\end{figure}
