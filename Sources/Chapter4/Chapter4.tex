...
Il recupero di $ T $ avviene con l'algoritmo ALS\todo{ref}
...
\begin{itemize}
	...
	\item Matrice delle sequenze di spreading $ C \in \{-1,1\}^{J \times R}  $: contiene i codici
	      ...
	      uguale probabilità.
\end{itemize}
L'algoritmo ALS \todo{ref} produce un tensore approssimante $ \hat{T} = \dsqr{\hat{A}, \hat{C},
		\hat{S}} $ unico a meno di permutazione e riscalamento dei fattori: per costruzione, l'Equazione~\ref{eq:krk_eq_full_rank} è
...
Descriviamo brevemente il procedimento. Indichiamo con $ (a_{r},c_{r},s_{r}) $ i fattori di $ T $ e
...
ulteriori esecuzioni dell'algoritmo su sei configurazioni spaziali differenti.\todo{Cosa ne pensa di
	queste figure?}
