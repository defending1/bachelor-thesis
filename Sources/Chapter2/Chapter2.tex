...
\begin{remark}
  ...
  d'interesse della geometria algebrica. Si veda ad esempio~\cite{landsberg2011tensors}
\end{remark}
...
\begin{theorem}[Strassen \cite{strassen69}, also see \cite{burgisser2013algebraic} §15.1]
 \begin{equation*}
