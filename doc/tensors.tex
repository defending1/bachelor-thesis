...
\lstdefinestyle{tensorlatex}{
  ...
  morekeywords={[2] 
    Vc, Mx, Tr, Tn, Tm, Inv,
    prn, angb, algob, crly, sqr, ceil, floor, dsqr, nrm, tnrm, fnrm, abs,
...
\begin{tabular}{|l|l|l|} \hline
  ...
  \ExampleRow{\algob{\cdot}, \algob<\cdot>}{Algorithm/matrix multiplication angle braces ($\algob{n} = \langle n,n,n \rangle$)} 
